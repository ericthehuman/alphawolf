...
renderTile() {
  return (
    <div>
      <Tile stockData={this.props.selectedStocks} onChange={this.changeToSector.bind(this)} sectorAddFunction={this.addStockFromSector.bind(this)}/>
    </div>
  );
}
...
changeToSector(sectorName) {
  ...
  if (sectorName.currentTarget.value === "financial") {
    var financials = Stocks.findOne({name: "Financials"});
    SelectedStock.set([{ code: sectorName.currentTarget.value, news: financials.news }]);
  } else if (sectorName.currentTarget.value === "materials") {
    var materials = Stocks.findOne({name: "Materials"});
    SelectedStock.set([{ code: sectorName.currentTarget.value, news: materials.news }]);
  } else {
...
// New submit
addStockFromSector(e) {

  var companyCode = e.currentTarget.value;
  console.log("Company code is: " + companyCode);
